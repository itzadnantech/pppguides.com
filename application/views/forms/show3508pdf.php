...
<body>
    ...
    <main id="dbs_form">
        <div class="container">
            <header style="margin-top:100px;">
                <div class="text-center">
                    <span class="loader-div" style="display:none;">	
                              Generating PDF - Please Wait...&nbsp;<img src="<?php echo base_url('assets/excelimport/loader.gif'); ?>" style="width:4%;" />
                              <br />
                              </span>
                    <a href="<?php echo base_url()?>Form3508/generatePDF" onclick="showGif()" class="btn btn-success">Download PDF</a>
                    <a href="<?php echo base_url()?>Form3508/applyForForgiveness" class="btn btn-info">Home</a>
                </div>
            <br>
            <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 text-center">
                            ...
                            <h4 class="center"><b>Loan Forgiveness Application Revised June 16, 2020 </b></h4>
                        </div>
                        <div class="col-xs-3 text-right">
                            <h5 style="margin-top:5px;">
                                <b>OMB Control Number 3245-0407 </b>
                            </h5>
                            <h5><b>Expiration Date: 10/31/2020</b></h5>
                        </div>
                    </div>
            </header>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="content top-header">
                        <table class="table table-bordered" cellspacing="0" cellpadding="0" style="text-align: center" style="margin-top:100px">
            ...
            <div class="row">
                <div class="col-xs-6">
                    <div class="box"><b>SBA PPP Loan Number:</b> <span class="underline full_width center"><?php echo $val['sba']?></span></div>
                </div>
                <div class="col-xs-6">
                    <div class="box"><b>Lender PPP Loan Number:</b> <span class="underline full_width center"><?php echo $val['loan_number']?></span></div>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-xs-6">
                    <div class="box"><b>PPP Loan Amount:</b> <span class="underline full_width center"><?php echo $val['loan_amount']?></span></div>
                </div>
                <div class="col-xs-6">
                    <div class="box"><b>PPP Loan Disbursement Date: </b> <span class="underline full_width center"><?php echo $val['disbursement_date']?></span></div>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-xs-6">
                    <div class="box"><b>Employees at Time of Loan Application:</b> <span class="underline full_width center"><?php echo $val['loantime_employees']?></span></div>
                </div>
                <div class="col-xs-6">
                    <div class="box"><b>Employees at Time of Forgiveness Application: </b> <span class="underline full_width center"><?php echo $val['forgivenesstime_employees']?></span></div>
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-xs-6">
                    <div class="box"><b>EIDL Advance Amount:</b> <span class="underline full_width center"><?php echo $val['eidl_grant_amount']?></span></div>
                </div>
                <div class="col-xs-6">
                    <div class="box"><b>EIDL Application Number: </b><span class="underline full_width center"> <?php echo $val['eidl_grant_app_num']?></span></div>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-xs-11">
                    <b>Payroll Schedule: </b> The frequency with which payroll is paid to employees is:
                </div>
            </div>
            <br>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-xs-11">
                    <div class="box"><b>Covered Period:</b><span class="underline full_width center"><?php echo $val['covered_period']?></span></div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-11">
                    <div class="box"><b>Alternative Payroll Covered Period,if applicable:</b><span class="underline full_width center"><?php echo $val['alternate_period']?></span></div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 underline center">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="load-form" style="padding: 20px;text-align: justify;">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    <p><b>Table 1:</b> List employees who:</p>
                    <ul>
            ...
            <table class="table table-bordered top-header" cellspacing="0" cellpadding="0">
            ...
            <div class="row">
                ...
                <div class="col-xs-8">
                    ...
                    <table class="table table-bordered top-header" cellspacing="0" cellpadding="0" style="text-align: center">
            ...
            <div class="row">
                <div class="col-xs-11">
                    <p><u><b>PPP Borrower Demographic Information Form (Optional)</b></u></p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-11">
                    ...
                    <ol>
                        ...
                        <li><u><b>Purpose.</b></u> Veteran/gender/race/ethnicity data is collected for program reporting purposes only</li>
                        <li><u><b>Description.</b></u> This form requests information about each of the Borrower’s Principals. Add additional sheets if necessary.</li>
                        <li> <u><b>Definition of Principal.</b></u> The term “Principal” means:
                            <ul>
                        ...
                        <li><u><b>Principal Name. </b></u> Insert the full name of the Principal</li>
                        <li><u><b>Position. </b></u> Identify the Principal’s position; for example, self-employed individual; independent contractor; sole proprietor;
            ...
            <table class="table table-bordered top-header" cellspacing="0" cellpadding="0" style="margin-bottom: 0;">
            ...
            <table class="table table-bordered tbl-loan top-header" cellspacing="0" cellpadding="0" style="margin-top:0">
    ...
    <footer>
        ...
        <p style="text-align: left">SBA Form 3508 (06/20)<br>
            Page 1</p>
-->
